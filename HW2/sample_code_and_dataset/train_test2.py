...
if __name__ == '__main__':
    ...
    encoder = SAGEEncoder(in_size, 64, 64)
    encoder.load_state_dict(torch.load(args.pretrained))   # 新增 CLI 參數 --pretrained
    model = nn.Sequential(encoder, nn.Linear(64, num_classes)).to(device)
